 ...
 *** Codefile             : UInt_8_2_Bits_Right.c
 ***
...
#ifndef UINT_8_2_BITS_RIGHT_C
#define UINT_8_2_BITS_RIGHT_C
...
\******************************************************************************/
UInt8 Sa5_Extract_Bits; /* LSB: 2^0 OFF: 0 MIN/MAX: 0 .. 9 */
UInt8 Sa5_Extract_Bits1; /* LSB: 2^0 OFF: 0 MIN/MAX: 0 .. 9 */
UInt8 Sa5_Extract_Bits2; /* LSB: 2^0 OFF: 0 MIN/MAX: 0 .. 9 */
UInt8 Sa5_Extract_Bits3; /* LSB: 2^0 OFF: 0 MIN/MAX: 0 .. 9 */
 ...
 ***
\**************************************************************************************************/
void UInt_8_2_Bits_Right(void)
{
   /* TwoDigit_7SegDisp/Disp_Driver/UInt_8_2_Bits_Right/Extract Bits3 */
   Sa5_Extract_Bits3 = (Sa3_Sum & 8) >> 3;

   /* TwoDigit_7SegDisp/Disp_Driver/UInt_8_2_Bits_Right/Extract Bits2 */
   Sa5_Extract_Bits2 = (Sa3_Sum & 4) >> 2;

   /* TwoDigit_7SegDisp/Disp_Driver/UInt_8_2_Bits_Right/Extract Bits1 */
   Sa5_Extract_Bits1 = (Sa3_Sum & 2) >> 1;

   /* TwoDigit_7SegDisp/Disp_Driver/UInt_8_2_Bits_Right/Extract Bits */
   Sa5_Extract_Bits = Sa3_Sum & 1;
}

/*----------------------------------------------------------------------------*\
  MODULE LOCAL FUNCTION DEFINITIONS
\*----------------------------------------------------------------------------*/
#endif /* UINT_8_2_BITS_RIGHT_C */
/*----------------------------------------------------------------------------*\
  END OF FILE
\*----------------------------------------------------------------------------*/
